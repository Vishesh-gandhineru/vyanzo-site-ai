    ...
    <section className="w-full bg-text-dark-bg text-text-light-bg py-24 px-4 md:px-8 overflow-hidden font-sans border-t border-brand-ash/20">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-sm font-semibold tracking-widest text-[#d5b060] uppercase mb-6 flex items-center gap-4">
              <span className="w-8 h-px bg-[#d5b060]"></span>
              About Vyanzo
            </h2>
            ...
            <div className="border-l-4 border-[#d5b060] pl-6 py-2">
          ...
          >
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl border border-brand-ash/20 mt-6 relative overflow-hidden group shadow-lg">
               {/* Decorative gradient */}
               <div className="absolute top-0 right-0 w-32 h-32 bg-[#d5b060]/10 rounded-full blur-2xl -mr-16 -mt-16 transition-transform group-hover:scale-150 duration-700 ease-out"></div>
