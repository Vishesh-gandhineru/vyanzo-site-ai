    ...
    <section className="w-full bg-white py-24 px-4 md:px-8 overflow-hidden font-sans border-t border-black/5">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
          ...
          >
            <h2 className="text-xs font-bold tracking-[0.15em] text-[#eab308] uppercase mb-8 flex items-center gap-3">
            ...
            <h3 className="text-4xl md:text-5xl lg:text-[4rem] font-serif text-bg-dark leading-[1.1] mb-8">
              ...
              <span className="text-[#10b981] italic">environmental impact</span> <br />
              through innovation.
            </h3>
            ...
            <div className="flex flex-wrap gap-4">
              <div className="flex items-center gap-3 bg-[#f0fdf4] px-5 py-3 rounded-full">
          ...
          <motion.div 
            ...
            className="lg:w-1/2 w-full h-[400px] md:h-[500px] lg:h-[600px] rounded-[2rem] overflow-hidden"
          >
            <img 
